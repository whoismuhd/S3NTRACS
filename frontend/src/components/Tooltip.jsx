...
export default function Tooltip({ children, content, position = 'top' }) {
  ...
  return (
    ...
    >
      ...
      {isVisible && content && (
        <div
          className={`absolute z-50 px-3 py-2 text-xs font-medium text-white bg-gray-800 rounded-lg shadow-lg whitespace-nowrap ${positionClasses[position]} animate-fade-in`}
        >
          {content}
